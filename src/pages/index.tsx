      ...
      >
        <div style={{ filter: focused ? "blur(10px)" : "none" }}>
          <div className="header">
            ...
            <p>
              So I made this for make my life easier but now I just want to help
              for those who want to run old FSG generators locally.
            </p>
            <p>
        ...
        {showGenerators && (
          <div className="generators">
            {generators
              ...
              .sort((a, b) =>
                a.verifiable === false ? 1 : b.verifiable === false ? -1 : 0
              )
              .map((gen) => (
                <GeneratorComponent
                  key={gen.name}
